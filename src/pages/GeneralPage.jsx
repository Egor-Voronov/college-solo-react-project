  ...
  return (
    <div className="content general-content">
      <div className="container o2">
          ...
          <br /> В частности - мы занимаемся автоматизацией и оптимизацией бизнес-процессов, облачными технологиями, машинным обучением, блокчейном, биометрией, искусственным 
          интеллектом, 
          роботизацией а также поставками торгового оборудования для бизнеса.</h3>
        ...
        <Link to='/products#header'><button className='cta'>Перейти в каталог</button></Link>
        <div id="portal"></div>
      </div>
    </div>
  )
